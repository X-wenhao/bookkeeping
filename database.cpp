...
bool createConnection(void)
{
    ...
    query.exec("create table analyze(id INTEGER PRIMARY KEY AUTOINCREMENT,time text,income float,outcome float,clothe float,food float,out float,other float)");
